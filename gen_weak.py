...
def get_args() -> Namespace:
    ...
    parser.add_argument("--base_folder", type=str, default='./data/promise_WSS/train')
    parser.add_argument("--save_subfolder", type=str, default='box')
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--strategy", type=str, default='box_strat')
    parser.add_argument("--selected_class", type=int, default=1,
                        help="Default used to be 3")
    parser.add_argument("--filling", type=int, default=1,
                        help="Default used to be 3")

    parser.add_argument("--verbose", action="store_true")
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--allow_bigger", type=int, default='1')
    parser.add_argument("--allow_overflow", type=int, default='1')
